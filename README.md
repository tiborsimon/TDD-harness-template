...
__LedDriver__, that can control a 16 bit led port assigned to a memory address. [![Build Status](https://travis-ci.org/tiborsimon/TDD-harness-template.svg?branch=LedDriver)](https://travis-ci.org/tiborsimon/TDD-harness-template)
